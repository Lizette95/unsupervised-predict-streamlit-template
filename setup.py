...
setup(
    ...
    author = 'JHB_Team_RM4',
    author_email = ['bulelaninkosi9@gmail.com', 'lizette.loubser@hotmail.com', 'thandokhumalo184@gmail.com', 'cenygal@gmail.com', 'nompilomapilos@gmail.com', 'sjbhembe@hotmail.com'] # add emails
